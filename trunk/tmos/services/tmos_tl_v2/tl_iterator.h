...
#ifndef TL_ITERATOR_H_
#define TL_ITERATOR_H_
...
//    	       (tmos::__are_same<_Iter, typename _Container::pointer>::__value),
...
//#else
//inline typename __normal_iterator<_IteratorL, _Container>::difference_type operator-(
