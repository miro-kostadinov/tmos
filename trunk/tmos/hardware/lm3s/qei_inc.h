 ...
 * @defgroup lm3s_qei QEI
 * @{
 * @file     lm3s/qei_inc.h
 * @brief    Macros used when accessing the QEI hardware.
 *
...
#define QEI_CTL_FILTCNT_S       16			//!< doc!
