...
// Port A
#define PIN_UART4_TX	(PD_PA0  | PD_AF_OUT_2MHz)								//!< UART 4
#define PIN_PA1			(PD_PA1  | PD_OUT)										//!< unused
#define PIN_ETH_MDIO	(PD_PA2  | PD_AF)										//!< eth
#define PIN_PRN2_TH		(PD_PA3  | PD_ANALOG)									//!< prn 2
#define PIN_VPRN		(PD_PA4  | PD_ANALOG)									//!< prn
#define PIN_SPI1_SCK	(PD_PA5  | PD_AF)										//!< spi 1
#define PIN_SPI1_MISO	(PD_PA6  | PD_AF)										//!< spi 1
#define PIN_ETH_CRS_DV	(PD_PA7  | PD_AF)										//!< eth
#define PIN_PA8			(PD_PA8  | PD_OUT)										//!< unused
#define PIN_UART1_TX	(PD_PA9  | PD_AF)										//!< uart 1
#define PIN_UART1_RX	(PD_PA10 | PD_AF)										//!< uart 1
...
#define PIN_SPI1_MOSI	(PD_PB5  | PD_AF)										//!< spi 1
...
#define PIN_SPI2_SCK	(PD_PB10 | PD_AF)										//!< spi 2
#define PIN_ETH_TX_EN	(PD_PB11 | PD_AF)										//!< eth
#define PIN_PB12		(PD_PB12 | PD_OUT)										//!< unused
#define PIN_USB_VBUS	(PD_PB13 | PD_AF)										//!< usb
#define PIN_USB_DM		(PD_PB14 | PD_AF)										//!< usb
#define PIN_USB_DP		(PD_PB15 | PD_AF)										//!< usb

// Port C
#define PIN_PRN2_PS		(PD_PC0  | PD_IN)										//!< prn 2
#define PIN_ETH_MDC		(PD_PC1  | PD_IN)										//!< eth
#define PIN_PWR_ADC		(PD_PC2  | PD_ANALOG)									//!< pwr
#define PIN_DI			(PD_PC3  | PD_AF)										//!< spi 2
#define PIN_ETH_RXD0	(PD_PC4  | PD_AF)										//!< eth
#define PIN_ETH_RXD1	(PD_PC5  | PD_AF)										//!< eth
#define PIN_USART6_TX	(PD_PC6  | PD_AF)										//!< usart 6
#define PIN_USART6_RX	(PD_PC7  | PD_IN)						 				//!< usart 6
#define PIN_LCD_BL		(PD_PC8  | PD_OUT)                                      //!< lcd
#define PIN_GSM_ON		(PD_PC9  | PD_OUT | PD_ACTIVE_HIGH)                     //!< gsm
#define PIN_SPI3_SCK	(PD_PC10 | PD_AF)                                       //!< spi 3
#define PIN_UART4_RX	(PD_PC11 | PD_AF) 					                    //!< uart 4
#define PIN_SPI3_MOSI 	(PD_PC12 | PD_AF) 					                    //!< spi 3
#define PIN_JP3			(PD_PC13 | PD_IN)                                       //!< jp3
#define PIN_OSC32_IN	(PD_PC14 | PD_AF)                                       //!< osc 32khz
#define PIN_OSC32_OUT	(PD_PC15 | PD_AF)                                       //!< osc 32khz

// Port D
#define PIN_M_D2		(PD_PD0  | PD_AF)										//!< bus
#define PIN_M_D3		(PD_PD1  | PD_AF)										//!< bus
#define PIN_DOPEN 		(PD_PD2  | PD_IN)										//!< dopen?
#define PIN_PFO			(PD_PD3  | PD_IN)										//!< scard
#define PIN_M_OE		(PD_PD4  | PD_AF)										//!< bus
#define PIN_M_WE		(PD_PD5  | PD_AF)										//!< bus
#define PIN_BOX			(PD_PD6  | PD_OUT | PD_ACTIVE_HIGH)						//!< box/service mode in
#define PIN_MCS0		(PD_PD7  | PD_AF)						 				//!< bus
#define PIN_SC_IO		(PD_PD8  | PD_AF) 		                                //!< scard
#define PIN_SC_RST		(PD_PD9  | PD_AF)       			          			//!< scard
#define PIN_SC_CLK		(PD_PD10 | PD_AF)                                       //!< scard
#define PIN_M_A16		(PD_PD11 | PD_AF) 					                    //!< bus
#define PIN_M_A17	 	(PD_PD12 | PD_AF) 					                    //!< bus
#define PIN_M_A18		(PD_PD13 | PD_AF)                                       //!< bus
#define PIN_M_D0		(PD_PD14 | PD_AF)                                       //!< bus
...
#define PIN_M_D7		(PD_PE10 | PD_AF)                                       //!< bus
...
// Port F
#define PIN_M_A0		(PD_PF0  | PD_AF)										//!< bus
#define PIN_M_A1		(PD_PF1  | PD_AF)										//!< bus
#define PIN_M_A2	 	(PD_PF2  | PD_AF)										//!< bus
#define PIN_M_A3		(PD_PF3  | PD_AF)										//!< bus
#define PIN_M_A4		(PD_PF4  | PD_AF)										//!< bus
#define PIN_M_A5		(PD_PF5  | PD_AF)										//!< bus
...
#define PIN_M_A6	 	(PD_PF12 | PD_AF) 					                    //!< bus
#define PIN_M_A7		(PD_PF13 | PD_AF)                                       //!< bus
#define PIN_M_A8		(PD_PF14 | PD_AF)                                       //!< bus
#define PIN_M_A9		(PD_PF15 | PD_AF)                                       //!< bus

// Port G
#define PIN_M_A10		(PD_PG0  | PD_AF)										//!< bus
#define PIN_M_A11		(PD_PG1  | PD_AF)										//!< bus
#define PIN_M_A12		(PD_PG2  | PD_AF)										//!< bus
#define PIN_M_A13		(PD_PG3  | PD_AF)										//!< bus
#define PIN_M_A14		(PD_PG4  | PD_AF)										//!< bus
#define PIN_M_A15		(PD_PG5  | PD_AF)										//!< bus
...
#define PIN_M_CS1		(PD_PG9  | PD_AF) 					                    //!< bus
#define PIN_LED3		(PD_PG10 | PD_OUT | PD_ACTIVE_HIGH)                     //!< led
#define PIN_ETH_IRQ		(PD_PG11 | PD_IN) 					                    //!< eth
#define PIN_GSM_CTS 	(PD_PG12 | PD_AF) 					                    //!< gsm (uart6 rts)
#define PIN_ETH_TXD0	(PD_PG13 | PD_AF)                                       //!< eth
#define PIN_ETH_TXD1	(PD_PG14 | PD_AF)                                       //!< eth
#define PIN_GSM_RTS		(PD_PG15 | PD_AF)                                       //!< gsm (usart6 cts)
