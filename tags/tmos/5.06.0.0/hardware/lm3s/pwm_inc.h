 ...
 * @defgroup lm3s_pwm PWM
 * @{
 * @file     lm3s/pwm_inc.h
 * @brief    Defines and Macros for Pulse Width Modulation (PWM) ports.
 *
...
#define PWM_X_DBRISE_DELAY_S    0			//!< doc!
...
#define PWM_X_DBFALL_DELAY_S    0			//!< doc!
...
#define PWM_X_MINFLTPER_S       0			//!< doc!
