 ...
 * @defgroup lm3s_ssi SSI
 * @{
 * @file     lm3s/ssi_inc.h
 * @brief    Macros used when accessing the SSI hardware.
 *
...
#define SSI_CPSR_CPSDVSR_S      0			//!< doc!
