...
extern "C" char * const DRV_TABLE[INALID_DRV_INDX+1] __attribute__ ((section (".DriverTable")))  =
{
    ...
    1+ (char * const)&DefaultDriver, 	/*!< 20 USB Device Low Priority or CAN1 RX0 Interrupts */
    ...
    1+ (char * const)&DefaultDriver, 	/*!< 24 TIM1 Break Interrupt                 */
    1+ (char * const)&DefaultDriver, 	/*!< 25 TIM1 Update Interrupt                */
    1+ (char * const)&DefaultDriver, 	/*!< 26 TIM1 Trigger and Commutation Interrupt */
    1+ (char * const)&DefaultDriver, 	/*!< 27 TIM1 Capture Compare Interrupt       */
    1+ (char * const)&t2cci_driver, 	/*!< 28 TIM2 global Interrupt                */
    ...
    1+ (char * const)&DefaultDriver, 	/*!< 41 RTC Alarm through EXTI Line Interrupt */
    1+ (char * const)&DefaultDriver, 	/*!< 42 USB Device WakeUp from suspend through EXTI Line Interrupt */
