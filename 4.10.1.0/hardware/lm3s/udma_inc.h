 ...
 * @defgroup lm3s_udma UDMA
 * @{
 * @file     lm3s/udma_inc.h
 * @brief    Macros for use in accessing the UDMA registers.
 *
...
#define UDMA_STAT_DMACHANS_S    16			//!< doc!
...
#define UDMA_CTLBASE_ADDR_S     10			//!< doc!
...
#define UDMA_ALTBASE_ADDR_M     0xFFFFFFFF  //!< Alternate Channel Address
                                            //!< Pointer
#define UDMA_ALTBASE_ADDR_S     0			//!< doc!
...
#define UDMA_SRCENDP_ADDR_S     0			//!< doc!
...
#define UDMA_DSTENDP_ADDR_S     0			//!< doc!
...
#define UDMA_CHCTL_XFERMODE_PER_SGA \
                                0x00000007  //!< Alternate Peripheral
                                            //!< Scatter-Gather
#define UDMA_CHCTL_XFERSIZE_S   4			//!< doc!
