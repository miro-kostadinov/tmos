...
#ifndef TTL_TYPE_TRAITS_H_
#define TTL_TYPE_TRAITS_H_
...
/**
  ...
  template<typename _Tp, ttl::size_t _Size>
  ...
  template<>
    struct __is_nullptr_t_helper<decltype(nullptr)>
    : public true_type { };
  ...
  template<typename _Tp>
    struct alignment_of
    : public integral_constant<ttl::size_t, __alignof__(_Tp)> { };

  /// rank
  template<typename>
    struct rank
    : public integral_constant<ttl::size_t, 0> { };

  template<typename _Tp, ttl::size_t _Size>
    struct rank<_Tp[_Size]>
    : public integral_constant<ttl::size_t, 1 + rank<_Tp>::value> { };
  ...
  template<typename _Tp, unsigned _Uint, ttl::size_t _Size>
    struct extent<_Tp[_Size], _Uint>
    : public integral_constant<ttl::size_t,
  ...
  template<typename _From, typename _To>
    ...
    : public __sfinae_types
    {
      ...
      template<typename _From1, typename _To1>
        static decltype(__test_aux<_To1>(ttl::declval<_From1>()), __one())
	__test(int);
  ...
  */
  template<ttl::size_t _Len, ttl::size_t _Align =
  ...
  template<typename _Res, typename _Class, typename _Arg>
	...
	static _Tp _S_get(const _Class&);
      template<typename _Tp>
	static decltype(*ttl::declval<_Tp>()) _S_get(...);

    public:
      typedef
        decltype(_S_get<_Arg>(ttl::declval<_Arg>()).*ttl::declval<_Func>())
        __type;
    };
  ...
  template<typename _Functor, typename... _ArgTypes>
    ...
    {
      typedef
        decltype( ttl::declval<_Functor>()(ttl::declval<_ArgTypes>()...) )
        __type;
    };
