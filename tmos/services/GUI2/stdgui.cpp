...
RECT_T::RECT_T (short int x0_t, short int y0_t, short int x1_t, short int y1_t)
{
	x0 = x0_t;
	y0 = y0_t;
	x1 = x1_t;
...
bool RECT_T::normalize (RECT_T rect)
{
...
RECT_T& RECT_T::operator= (RECT_T rect_t)
{
...
bool RECT_T::operator== (RECT_T rect_t)
{
	return (as_int == rect_t.as_int);
}

bool RECT_T::operator== (int val)
{
	if (y1 == val)
		if (x1 == val)
			if (y0 == val)
