...
#ifndef USB_STD_DTORS_H_
#define USB_STD_DTORS_H_

#include <tmos.h>
#include <usb_opt.h>

/**
    Standard USB device descriptors (generic header, configuration, endpoint etc.)
*/
...
/// USB Sub Class Codes
typedef unsigned char USBSubClassCode;
#define INTERFACE_DEFINED_SUBCLASS 	0x00 //!< The sub class is defined in the interface(s)
#define VENDOR_SPECIFIC_SUBCLASS	0xFF //!< Vendor Specific


/// USB Protocol Codes
typedef unsigned char USBProtocolCode;
#define INTERFACE_DEFINED_PROTOCOL 	0x00  //!< The protocol is defined in the interface(s)
#define VENDOR_SPECIFIC_PROTOCOL	0xFF  //!< Vendor Specific
...
/// OTG Attribute Fields: Reserved D1: HNP support D0: SRP support
