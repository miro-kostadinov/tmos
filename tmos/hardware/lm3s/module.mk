...
local_cpp_src-y	+= uart_lm3s.cpp timer_lm3s.cpp flash_lm3s.cpp ethernet_lm3s.cpp
...
local_h_src-y 	+= timer_lm3s.h flash_lm3s.h ethernet_lm3s.h ethernet_inc.h
local_h_src-y 	+= rom_lm3s.h usb_lm3s.h 
