 ...
 * @defgroup lm3s_timer TIMER
 * @{
 * @file     lm3s/timer_inc.h
 * @brief    Defines and macros used when accessing the timer.
 *
...
#define TIMER_TAILR_TAILRL_M    0x0000FFFF  //!< GPTM TimerA Interval Load
                                            //!< Register Low
#define TIMER_TAILR_TAILRH_S    16			//!< doc!
#define TIMER_TAILR_TAILRL_S    0			//!< doc!
...
#define TIMER_TBILR_TBILRL_M    0x0000FFFF  //!< GPTM TimerB Interval Load
                                            //!< Register
#define TIMER_TBILR_TBILRL_S    0			//!< doc!
...
#define TIMER_TAMATCHR_TAMRH_S  16			//!< doc!
#define TIMER_TAMATCHR_TAMRL_S  0			//!< doc!
...
#define TIMER_TBMATCHR_TBMRL_S  0			//!< doc!
...
#define TIMER_TAPR_TAPSR_S      0			//!< doc!
...
#define TIMER_TBPR_TBPSR_S      0			//!< doc!
...
#define TIMER_TAPMR_TAPSMR_S    0			//!< doc!
...
#define TIMER_TBPMR_TBPSMR_S    0			//!< doc!
...
#define TIMER_TAR_TARH_S        16			//!< doc!
#define TIMER_TAR_TARL_S        0			//!< doc!
...
#define TIMER_TAV_TAVH_S        16			//!< doc!
#define TIMER_TAV_TAVL_S        0			//!< doc!
