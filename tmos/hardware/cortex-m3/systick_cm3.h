/**************************************************************************//**
 * @ingroup	hardware_cm3_systick
 * @file	hardware/cortex-m3/systick_cm3.h
 * @brief  	Cortex-M3 SYST
 * @date    18. December 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm3_systick  System timer, SysTick (SYST)
 * @ingroup	 hardware_cm3
 * Source and definitions for Cortex-M3  System timer, SysTick (SYST)
 * @{
 *
 ******************************************************************************/
