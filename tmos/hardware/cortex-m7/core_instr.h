/**************************************************************************//**
 * @ingroup	hardware_cm7_core_instr
 * @file	hardware/cortex-m7/core_instr.h
 * @brief  	Cortex-M7 instructions
 * @date    18. December 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm7_core_instr  Core inline instructions
 * @ingroup	 hardware_cm7
 * Source and definitions for Cortex-M7  Core inline instructions
 * @{
 *
 ******************************************************************************/
