/**************************************************************************//**
 * @ingroup	hardware_cm7_mpu
 * @file	hardware/cortex-m7/mpu_cm7.h
 * @brief  	Cortex-M7 MPU
 * @date    18. December 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm7_mpu  Memory Protection Unit (MPU)
 * @ingroup	 hardware_cm7
 * Source and definitions for Cortex-M7  Memory Protection Unit (MPU)
 * @{
 *
 ******************************************************************************/
