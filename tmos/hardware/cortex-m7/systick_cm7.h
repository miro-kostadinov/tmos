/**************************************************************************//**
 * @ingroup	hardware_cm7_systick
 * @file	hardware/cortex-m7/systick_cm7.h
 * @brief  	Cortex-M7 SYST
 * @date    02. October 2020
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm7_systick  System timer, SysTick (SYST)
 * @ingroup	 hardware_cm7
 * Source and definitions for Cortex-M7  System timer, SysTick (SYST)
 * @{
 *
 ******************************************************************************/

#ifndef SYSTICK_CM7_H_
#define SYSTICK_CM7_H_
