/**************************************************************************//**
 * @ingroup	hardware_cm7_nvic
 * @file	hardware/cortex-m7/nvic_cm7.h
 * @brief  	Cortex-M7 NVIC
 * @date    18. December 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm7_nvic  Nested Vectored Interrupt Controller (NVIC)
 * @ingroup	 hardware_cm7
 * Source and definitions for Cortex-M7  Nested Vectored Interrupt Controller (NVIC)
 * @{
 *
 ******************************************************************************/
