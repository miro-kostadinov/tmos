/**************************************************************************//**
 * @ingroup	hardware_cm7_tpiu
 * @file	hardware/cortex-m7/tpiu_cm7.h
 * @brief  	Cortex-M7 TPIU
 * @date    18. December 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_cm7_tpiu  Trace Port Interface Unit (TPIU)
 * @ingroup	 hardware_cm7
 * Source and definitions for Cortex-M7  Trace Port Interface Unit (TPIU)
 * @{
 *
 ******************************************************************************/
...
struct TPIU_Type
{
  ...
  __I  uint32_t TPIU_DEVTYPE; 	//!< (TPIU Offset: 0xFCC) Device Type register
};
#endif /* __ASSEMBLY__ */
