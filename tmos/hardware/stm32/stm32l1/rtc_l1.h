/**************************************************************************//**
 * @ingroup	hardware_stm32l1_rtc
 * @file	hardware/stm32/stm32l1/rtc_l1.h
 * @brief  	STM32L1 RTC
 * @date    13. February 2012
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_stm32l1_rtc  Real-Time Clock (RTC)
 * @ingroup	 hardware_stm32l1
 * Source and definitions for STM32L1 Real-Time Clock (RTC)
 * @{
 *
 ******************************************************************************/
...
#define RTC_ISR_TAMP3F              0x00008000 //!< TAMP3F: TAMPER3 detection flag
