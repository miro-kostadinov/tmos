/**************************************************************************//**
 * @ingroup	hardware_stm32f4_dbgmcu
 * @file	hardware/stm32/stm32f4/dbgmcu_f4.h
 * @brief  	STM32F4 DBGMCU
 * @date    29. October 2012
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_stm32f4_dbgmcu  MCU debug component (DBGMCU)
 * @ingroup	 hardware_stm32f4
 * Source and definitions for STM32F4 MCU debug component (DBGMCU)
 * @{
 *
 ******************************************************************************/
