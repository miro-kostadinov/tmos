/**************************************************************************//**
 * @ingroup	hardware_stm32h7_dma
 * @file	hardware/stm32/stm32h7/dma_h7.h
 * @brief  	STM32H7 DMA
 * @date    30. December 2019
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_stm32h7_dma  DMA Controller
 * @ingroup	 hardware_stm32h7
 * Source and definitions for STM32H7 DMA Controller
 * @{
 *
 ******************************************************************************/
...
typedef struct
{
  __IO uint32_t DMA_ISR[2];		 //!< (dma Offset: 0x00) DMA low/high DMA_LISR/DMA_HISR interrupt status register
...
#define STM32_DMA_ERRORS (DMA_ISR_TEIFx | DMA_ISR_DMEIFx )	//!< errors for H7 (DMA_ISR_FEIFx is fake???)

#define STM32_DMA_COMPLETE (DMA_ISR_TCIFx)	//!< complete for H7
#define STM32_DMA_HALF (DMA_IFCR_CHTIFx)	//!< half transfer for H7
