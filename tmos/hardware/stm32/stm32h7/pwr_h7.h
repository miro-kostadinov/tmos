...
/** @{ */
#define PWR_CPUCR_RUN_D3		0x00000800 //!< Keep system D3 domain in Run mode regardless of the CPU subsystem modes
...
#define PWR_WKUPEPR_WKUPPUPD6_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD6_up	0x04000000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD6_down	0x08000000 //!<  Pull-down
#define PWR_WKUPEPR_WKUPPUPD5		0x03000000 //!< Wakeup pin pull configuration for WKUP(truncate(n/2)-7)
#define PWR_WKUPEPR_WKUPPUPD5_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD5_up	0x01000000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD5_down	0x02000000 //!<  Pull-down
#define PWR_WKUPEPR_WKUPPUPD4		0x00C00000 //!< Wakeup pin pull configuration for WKUP(truncate(n/2)-7)
#define PWR_WKUPEPR_WKUPPUPD4_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD4_up	0x00400000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD4_down	0x00800000 //!<  Pull-down
#define PWR_WKUPEPR_WKUPPUPD3		0x00300000 //!< Wakeup pin pull configuration for WKUP(truncate(n/2)-7)
#define PWR_WKUPEPR_WKUPPUPD3_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD3_up	0x00100000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD3_down	0x00200000 //!<  Pull-down
#define PWR_WKUPEPR_WKUPPUPD2		0x000C0000 //!< Wakeup pin pull configuration for WKUP(truncate(n/2)-7)
#define PWR_WKUPEPR_WKUPPUPD2_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD2_up	0x00040000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD2_down	0x00080000 //!<  Pull-down
#define PWR_WKUPEPR_WKUPPUPD1		0x00030000 //!< Wakeup pin pull configuration for WKUP(truncate(n/2)-7)
#define PWR_WKUPEPR_WKUPPUPD1_off	0x00000000 //!<  No pull-up
#define PWR_WKUPEPR_WKUPPUPD1_up	0x00010000 //!<  Pull-up
#define PWR_WKUPEPR_WKUPPUPD1_down	0x00020000 //!<  Pull-down
