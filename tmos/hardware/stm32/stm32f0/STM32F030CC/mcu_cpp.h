/**************************************************************************//**
 * @file     hardware/stm32/stm32f0/STM32F030CC/mcu_cpp.h
 * @ingroup	 hardware_stm32f030CC
 * @brief    STM32F030CC header
 * @version  V3.00
...
/* ************************************************************************** */
/*   BASE ADDRESS DEFINITIONS FOR STM32F030CC */
/* ************************************************************************** */
/**
 * @ingroup	 STM32F030CC
...
#define USART4      CAST(USART_TypeDef  , BASE_USART4)	//!< USART4
#define USART5      CAST(USART_TypeDef  , BASE_USART5)	//!< USART5
...
#define ID_PERIPH_USART6	((1<<5)| 5) //!< USART 6
...
#define ID_PERIPH_TIM7      ((2<<5)| 5) //!< TIM 7
