/**************************************************************************//**
 * @ingroup	hardware_stm32f3_adc
 * @file	hardware/stm32/stm32f3/adc_f3.h
 * @brief  	STM32F3 ADC
 * @date    22. February 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_stm32f3_adc  Analog to Digital Converter (ADC)
 * @ingroup	 hardware_stm32f3
 * Source and definitions for STM32F3 Analog to Digital Converter (ADC)
 * @{
 *
 ******************************************************************************/
