/**************************************************************************//**
 * @ingroup	hardware_stm32f3_rtc
 * @file	hardware/stm32/stm32f3/rtc_f3.h
 * @brief  	STM32F3 rtc
 * @date    13. February 2013
 * @author	Miroslav Kostadinov
 *
 * @defgroup hardware_stm32f3_rtc  Real-Time Clock (RTC)
 * @ingroup	 hardware_stm32f3
 * Source and definitions for STM32F3 Real-Time Clock (RTC)
 * @{
 *
 ******************************************************************************/
...
typedef struct
{
  ...
  __IO uint32_t reserved2;  		//!< (rtc Offset: 0x4C) Reserved
  __IO uint32_t RTC_BKPxR[32]; 		//!< (rtc Offset: 0x50) RTC backup registers
...
#define RTC_ISR_TAMP3F              0x00008000 //!< TAMP3F: RTC_TAMP3 detection flag
#define RTC_ISR_TAMP2F              0x00004000 //!< TAMP2F: RTC_TAMP2 detection flag
...
/** @{ */
#define RTC_SHIFTR_ADD1S            0x80000000 //!< ADD1S: Add one second
...
#define RTC_TAFCR_TAMPPUDIS         0x00008000 //!< TAMPPUDIS: RTC_TAMPx pull-up disable
#define RTC_TAFCR_TAMPPRCH          0x00006000 //!< TAMPPRCH[1:0]: RTC_TAMPx precharge duration
#define RTC_TAFCR_TAMPFLT           0x00001800 //!< TAMPFLT[1:0]: RTC_TAMPx filter count
...
#define RTC_TAFCR_TAMP3TRG          0x00000040 //!< TAMP3TRG: Active level for RTC_TAMP3 input
#define RTC_TAFCR_TAMP3E            0x00000020 //!< TAMP3E: RTC_TAMP3 detection enable
